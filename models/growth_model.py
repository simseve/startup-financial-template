...
class SaaSGrowthModel:
    ...
    def run_model(self):
        ...
        for month_idx in range(1, self.config['projection_months']):
            ...
            for segment in self.config['segments']:
                ...
                new_arr = new_customers * self.config['initial_arr'][segment]
                churned_arr = churned_customers * \
                    self.config['initial_arr'][segment]

                # Update customer counts
                prev_customers = self.monthly_data.loc[month_idx -
                                                       1, f'{segment}_customers']
    ...
    def plot_growth_curves(self, figsize=(15, 15)):
        """
